                ...
                if attacker_weapon != ["0"]:
                    ...
                    if defender_weapon != ["0"]:
                        if int(defender_stats[20]) - int(defender_weapon[4]) < 0:
                            eff_spd_def = int(defender_stats[16]) + (int(defender_stats[20]) - int(defender_weapon[4]))
                        else:
                            eff_spd_def = int(defender_stats[16])
                    else:
                        eff_spd_def = int(defender_stats[16])
                    if attacker_weapon[1] == "Sword" or attacker_weapon[1] == "Lance" or attacker_weapon[1] == "Axe" \
                            or attacker_weapon[1] == "Bow" or attacker_weapon[1] == "Dagger":
                    ...
                    if defender_weapon != ["0"]:
                        ...
                        hit = ((int(defender_stats[15]) * 2) + (int(defender_stats[17]) / 2) + int(
                            defender_weapon[3])) - \
